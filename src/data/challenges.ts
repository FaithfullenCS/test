...
const zoneSeeds: Record<ZoneId, ZoneSeeds> = {
  gate_of_flow: {
    term: [
      ...
      {
        promptEn: 'profit for the year',
        correctRu: 'прибыль за год',
        distractors: ['долгосрочный долг', 'ежеквартальная выручка', 'валютный резерв'],
        hint: 'Это итоговый финансовый результат за отчетный год.',
        explanation: 'Profit for the year - чистый итог прибыли за период года.',
        keywords: ['profit for the year', 'прибыль'],
      },
      {
    ...
    boss: [
      {
        promptEn:
          'Cash from operating activities significantly affects profit for the year of food and beverage firms in Nigeria.',
        canonicalRu:
          'Денежные потоки от операционной деятельности существенно влияют на прибыль за год у пищевых и напиточных компаний Нигерии.',
        acceptableAnswers: [
          'Денежный поток от операционной деятельности значимо влияет на годовую прибыль компаний пищевой и напиточной отрасли Нигерии.',
          'Потоки денежных средств от операционной деятельности существенно влияют на прибыль за год фирм пищевой и напиточной отрасли в Нигерии.',
        ],
        requiredKeywords: ['операционной', 'влияют', 'прибыль', 'Нигерии'],
        keywordSynonyms: {
        ...
        hint: 'Сохрани связь: operating cash flow -> profit for the year.',
        explanation: 'Ключевой вывод статьи: операционный поток статистически значим для прибыли.',
        keywords: ['operating', 'profit', 'Nigeria'],
      },
      {
        promptEn:
          'The researcher adopted an ex-post facto design and used data from 2010 to 2019 financial statements.',
        canonicalRu:
          'Исследователь применил дизайн ex-post facto и использовал данные финансовой отчетности за 2010-2019 годы.',
        acceptableAnswers: [
          'Был применен дизайн ex-post facto, а данные взяты из финансовых отчетов за 2010-2019 годы.',
          'Автор использовал ex-post facto подход и данные из финансовой отчетности периода 2010-2019.',
        ],
        requiredKeywords: ['ex-post', 'данные', '2010', '2019'],
        keywordSynonyms: {
        ...
        keywords: ['ex-post facto', '2010', '2019'],
      },
      {
        promptEn:
          'The study recommends timely dividend payout because dividend paid has significant effect on net profit margin.',
        canonicalRu:
          'Исследование рекомендует своевременно выплачивать дивиденды, поскольку выплаченные дивиденды существенно влияют на чистую рентабельность.',
        acceptableAnswers: [
          'Авторы рекомендуют своевременную выплату дивидендов, так как она значимо влияет на чистую маржу прибыли.',
          'Рекомендовано вовремя выплачивать дивиденды, потому что это существенно отражается на чистой прибыльности.',
        ],
        requiredKeywords: ['дивиден', 'своеврем', 'влияют', 'чист'],
        keywordSynonyms: {
          дивиден: ['дивиден'],
          своеврем: ['своеврем', 'вовремя'],
          влияют: ['влияют', 'влияет', 'воздейств'],
          чист: ['чист', 'нетто'],
        },
        hint: 'Сохрани причинно-следственную связку «поскольку».',
        explanation: 'В рекомендации подчеркивается связь дивидендной политики и чистой маржи.',
        keywords: ['dividend', 'net profit margin'],
      },
      {
        promptEn:
  ...
  finance_harbor: {
    ...
    boss: [
      ...
      {
        promptEn:
          'The study found that financing cash flow has a significant effect on profit for the year.',
        canonicalRu:
        ...
        keywords: ['significant effect', 'profit for the year'],
      },
    ],
  },
  investment_factory: {
    ...
    boss: [
      ...
      {
        promptEn:
          'The study found that cash from investment activities significantly affects profit for the year.',
        canonicalRu:
        ...
        hint: 'Повтори структуру «significantly affects profit for the year».',
        explanation: 'Это третий статистически значимый вывод исследования.',
        keywords: ['significant', 'profit for the year'],
      },
    ],
  },
  council_hall: {
    term: [
      ...
      {
        promptEn: 'net profit margin',
        correctRu: 'чистая рентабельность',
        distractors: ['валовая рентабельность', 'операционная маржа', 'коэффициент ликвидности'],
        hint: 'Net profit relative to revenue.',
        explanation: 'Net profit margin показывает долю чистой прибыли в выручке.',
        keywords: ['net profit margin', 'чистая'],
      },
    ],
    sentence: [
      {
        promptEn:
          'The model has R2 of 0.733796, meaning about 73% of profit changes are explained by independent variables.',
        fragmentsRu: [
          'Модель имеет R2 = 0.733796,',
          'что означает объяснение примерно 73% изменений прибыли',
          'независимыми переменными.',
        ],
        hint: 'Передай идею «explained by independent variables».',
        explanation: 'R² интерпретируется как доля объясненной вариации.',
        keywords: ['R2', '73%', 'независимыми'],
      },
      {
        promptEn:
      ...
      {
        promptEn:
          'The study discovered significant effects of operating, financing and investing cash flows on profit for the year.',
        fragmentsRu: [
      ...
      {
        promptEn:
          'Food and beverage firms should pay dividends timely because dividends affect net profit margin.',
        fragmentsRu: [
          'Пищевые и напиточные компании должны',
          'вовремя выплачивать дивиденды,',
          'поскольку дивиденды влияют на чистую рентабельность.',
        ],
        hint: 'Timely = вовремя.',
        explanation: 'Это первая практическая рекомендация работы.',
        keywords: ['вовремя', 'дивиденды', 'рентабельность'],
      },
      {
        promptEn:
          'Tax agencies should be effective to avoid double taxation that depletes net profit margin.',
        fragmentsRu: [
          'Налоговые органы должны работать эффективно',
          'для предотвращения двойного налогообложения,',
          'которое снижает чистую рентабельность.',
        ],
        hint: 'Depletes = снижает, истощает.',
        explanation: 'Рекомендация связана с налоговой политикой и прибыльностью фирм.',
        keywords: ['налоговые', 'двойного', 'снижает'],
      },
      {
        promptEn:
          'Firms should improve finance income because finance is critical for planning, budgeting and risk control.',
        fragmentsRu: [
          'Компаниям следует улучшать финансовый доход,',
          'поскольку финансы критичны для планирования, бюджетирования',
          'и контроля рисков.',
        ],
        hint: 'Finance income можно передать как финансовый доход.',
        explanation: 'Финансы в статье описаны как основа управленческих решений.',
        keywords: ['финансовый', 'планирования', 'рисков'],
      },
    ],
    context: [
      {
      ...
      {
        contextEn: 'Recommendations were made for dividend policy, taxation, and finance income improvement.',
    ...
    boss: [
      ...
      },
      {
        ...
        canonicalRu:
          'Значение R2, равное 0.733796, означает, что около 73 процентов изменений прибыли объясняются независимыми переменными.',
        acceptableAnswers: [
          'R2 = 0.733796 показывает, что примерно 73% вариации прибыли объясняется независимыми переменными.',
          'Коэффициент R2 0.733796 указывает на объяснение примерно 73% изменений прибыли независимыми факторами.',
        ],
        requiredKeywords: ['R2', '73', 'измен', 'независ'],
        keywordSynonyms: {
          R2: ['r2'],
          '73': ['73'],
          измен: ['измен', 'вариац'],
      ...
      {
        promptEn:
          'The study concludes that operating, financing and investing cash flows all have significant effects on profit for the year.',
        canonicalRu:
          'Исследование делает вывод, что операционные, финансовые и инвестиционные денежные потоки все имеют значимое влияние на прибыль за год.',
        acceptableAnswers: [
          'В работе сделан вывод о значимом влиянии всех трех потоков - операционного, финансового и инвестиционного - на годовую прибыль.',
          'Авторы заключают, что operating, financing и investing cash flows значимо воздействуют на прибыль за год.',
        ],
        requiredKeywords: ['операц', 'финансов', 'инвестиц', 'прибыл'],
        keywordSynonyms: {
          операц: ['операц'],
          финансов: ['финансов'],
          инвестиц: ['инвестиц'],
      ...
      {
        promptEn:
          'The study recommends timely dividend payout, effective taxation administration, and improved finance income management.',
        canonicalRu:
          'Исследование рекомендует своевременную выплату дивидендов, эффективное налоговое администрирование и улучшение управления финансовыми доходами.',
        acceptableAnswers: [
          'В рекомендациях указаны три шага: вовремя выплачивать дивиденды, повысить эффективность налогового администрирования и улучшить управление финансовым доходом.',
          'Работа предлагает своевременные дивидендные выплаты, результативную налоговую работу и лучшее управление finance income.',
        ],
        requiredKeywords: ['дивиден', 'налог', 'улучш', 'финансов'],
        keywordSynonyms: {
          дивиден: ['дивиден'],
          налог: ['налог'],
          улучш: ['улучш', 'повыс'],
          финансов: ['финансов', 'finance'],
        },
        hint: 'Сохрани все три пункта рекомендаций.',
        explanation: 'Финальный практический блок статьи.',
        keywords: ['recommendations', 'dividend', 'taxation'],
      },
    ],
  },
};
